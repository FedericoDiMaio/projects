...
CREATE TABLE `transazioni` (
  `TransazioneID` int(11) NOT NULL,
  `UserID` int(11) DEFAULT NULL,
  `TipoTransazione` enum('Entrata','Uscita') NOT NULL,
  `Descrizione` varchar(255) NOT NULL,
  `Importo` decimal(10,2) NOT NULL,
  PRIMARY KEY (`TransazioneID`),
  KEY `UserID` (`UserID`),
  CONSTRAINT `transazioni_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `utenti_registrati` (`UserID`)
