...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql_locomativa = "SELECT * FROM locomotiva WHERE id_locomotiva = :id";
        $stmt_locomotiva_composizione = $db->prepare($sql_locomativa);
        ...
        echo 'locomotiva: ' . htmlspecialchars($dati_locomotiva['nome_locomotiva']) . '<br>';
    }
